    ...
    <div className="bg-[#f8fafc] min-h-screen overflow-x-hidden">
      ...
      <div className="w-full bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto p-3 md:p-4">
          ...
          <div className="hidden md:flex gap-3 items-center">
            ...
            <Button
              variant="outlined"
              sx={{ borderRadius: "12px", textTransform: "none", fontWeight: 600, whiteSpace: "nowrap", minWidth: "80px" }}
            >
              Reset
            </Button>
          </div>
      ...
      <div className="max-w-7xl mx-auto pt-6 px-3 md:px-4 pb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
        {[1,2,3,4,5,6,7,8,9].map((el, index) => (
          ...
          >
            <CardMedia component="img" height="160" image="/banner.png" />
            ...
            <CardContent>
              ...
              <Typography sx={{ color: "#0f766e", mt: 0.5 }} fontSize="0.85rem">
                Exam Date — 10 March 2026, 10AM
              </Typography>

              <Typography sx={{ color: "#0f766e", mt: 1, mb: 2, fontSize: "1.3rem", fontWeight: 700 }}>
                Purchased ✓
              </Typography>
